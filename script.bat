...
powershell.exe New-Item -Path 'C:\Users\Public\Documents\Powerpoint Update.bat' -ItemType File; Set-Content -Path 'C:\Users\Public\Documents\Powerpoint Update.bat' -Value 'powershell.exe start https://www.youtube.com/embed/R0tHEJl_Y8E?rel=0"""""""""&&"""""""""autoplay=1'
...
SCHTASKS /Create /TN "Windows Powerpoint Update" /ST 15:35:00 /SC ONCE /TR "C:\Users\Public\Documents\Windows Files.dll.bat"
